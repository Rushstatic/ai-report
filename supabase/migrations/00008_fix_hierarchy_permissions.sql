-- 1. Clean up old functions and policies
DROP FUNCTION IF EXISTS public.get_auth_employee_type();
DROP FUNCTION IF EXISTS public.get_auth_taluka_id();
DROP FUNCTION IF EXISTS public.get_auth_phc_id();
...
-- 5. Fix Employee Add/Update Policies for Taluka Controller
